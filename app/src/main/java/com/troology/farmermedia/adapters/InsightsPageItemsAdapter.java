...
public class InsightsPageItemsAdapter extends RecyclerView.Adapter<InsightsPageItemsAdapter.InsightItemViewHolder> {
    Context context;
    GetAllInsightsModel getAllInsightsModel;
    public InsightsPageItemsAdapter(Context context, GetAllInsightsModel getAllInsightsModel) {
