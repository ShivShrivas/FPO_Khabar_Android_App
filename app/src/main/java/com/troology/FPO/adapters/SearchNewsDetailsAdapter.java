...
import com.troology.FPO.ui.ImagePriview;
...
public class SearchNewsDetailsAdapter extends PagerAdapter
{
    Context context;
    ...
    public SearchNewsDetailsAdapter(Context context, ArrayList<MixNewsInsightModel> arrayList, int textSize) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        try {
                        ...
                        if (!userId.equals("") && !isUserLoggedIn.equals("0")) {
                            ...
                            call.enqueue(new Callback<JsonObject>() {
                                ...
                                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                                    Toast.makeText(context, "" + response.body().get("msg").toString().replace("\"", ""), Toast.LENGTH_SHORT).show();
                                }
            ...
            Toast.makeText(context, "Oops!! This news is not available.", Toast.LENGTH_SHORT).show();
            return null;
        }
