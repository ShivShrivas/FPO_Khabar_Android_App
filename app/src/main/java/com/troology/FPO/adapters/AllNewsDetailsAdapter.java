...
public class AllNewsDetailsAdapter extends PagerAdapter
{
    Context context;
    ...
    public AllNewsDetailsAdapter(Context context, ArrayList<GetAllLiveNewsModel> arrayList, int textSize) {
